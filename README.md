...
|----------|----------|------|--------------|
| **Linux** (AppImage) | [Soxial-0.1.6.AppImage](https://github.com/rabden/Soxial/releases/download/v0.1.6/Soxial-0.1.6.AppImage) | ~187 MB | `chmod +x Soxial-0.1.6.AppImage && ./Soxial-0.1.6.AppImage` |
| **Linux** (deb) | [soxial_0.1.6_amd64.deb](https://github.com/rabden/Soxial/releases/download/v0.1.6/soxial_0.1.6_amd64.deb) | ~143 MB | `sudo dpkg -i soxial_0.1.6_amd64.deb` |
| **macOS** (Apple Silicon) | [Soxial-0.1.6-arm64.dmg](https://github.com/rabden/Soxial/releases/download/v0.1.6/Soxial-0.1.6-arm64.dmg) | ~180 MB | Open dmg → drag to Applications. First launch: right-click → Open (unsigned) |
| **Windows** | [Soxial.Setup.0.1.6.exe](https://github.com/rabden/Soxial/releases/download/v0.1.6/Soxial.Setup.0.1.6.exe) | ~147 MB | Run installer. SmartScreen warning → "More info" → "Run anyway" |
